...
export default function CustomerRefund() {
    ...
    const headerList = ["Refund Id", "Refund Date", "Item Id", "Item Name", "Employee Id", "Employee Name", "Customer Id", "Customer Name", "Amount"]
    const retrieveTransactionUrl = "https://us-central1-liteinvbackend.cloudfunctions.net/transaction-retrieve_refund"
    const createTransactionUrl = "https://us-central1-liteinvbackend.cloudfunctions.net/transaction-create_refund"
    ...
    return (
        <Card>
            <CardHeader color="warning">
                ...
                <p className={classes.cardCategoryWhite}> Customer refunds back to stock </p>
              </CardHeader>
        ...
        <form
            onSubmit={async (e) => {
                ...
                if (!(itemId && employeeId && customerId && amount)) {
                    alert("Please input customer refund's information");
                    return;
                }
                try {
                    ...
                    if (result.status === 201) {
                        alert(`Customer Refund is successfully created`);
                        history.go(0)
                    }
                } catch (error) {
